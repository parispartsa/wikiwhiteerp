...
A **NFe (Nota Fiscal Eletrônica)** é um documento fiscal obrigatório para a maioria das operações comerciais entre empresas. Este guia apresenta o processo completo de configuração da emissão automática de NFe no ERP White, garantindo compliance fiscal e automatização do processo.
