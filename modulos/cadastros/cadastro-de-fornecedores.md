...
3. Clique no botão **+ Novo Fornecedor**
...
3. **Contatos Específicos**:
   ...
   - **Gerente**: Para questões comerciais
   - **Financeiro**: Para questões de pagamento

### 📍 **Passo 4: Endereço**
1. **CEP**: Digite o CEP (preenchimento automático)
2. **Endereço**: Rua, número, complemento
3. **Bairro**: Bairro da empresa
4. **Cidade/Estado**: Localização completa
5. **País**: Brasil (padrão)

### 💰 **Passo 5: Condições Comerciais**
1. **Condições de Pagamento**:
   - **À vista** - Desconto aplicável
...
3. **Dados Bancários**:
   ...
   - **PIX**: Chave PIX preferencial

### 📦 **Passo 6: Produtos e Códigos**
1. **Produtos Fornecidos**:
   - Vincule produtos específicos
   - Defina códigos de referência
   - Configure preços especiais

2. **Códigos de Referência**:
   - **Código do Fornecedor**: Como ele identifica o produto
   - **Código de Barras**: Se diferente do padrão
   - **Referência**: Código interno do fornecedor

### 📊 **Passo 7: Classificação**
1. **Categoria**:
   - **Principal**: Fornecedor estratégico
   - **Secundário**: Fornecedor alternativo
   - **Eventual**: Compras esporádicas

2. **Segmento**:
   - **Produtos**: Mercadorias para revenda
   - **Serviços**: Prestação de serviços
   - **Matéria-prima**: Insumos para produção

3. **Status**:
   - ✅ **Ativo**: Fornecedor em operação
   - ⏸️ **Inativo**: Temporariamente suspenso
   - ❌ **Bloqueado**: Problemas comerciais

### 💾 **Passo 8: Salvar e Confirmar**
1. **Revisar Dados**: Confira todas as informações
2. **Salvar**: Clique em **Salvar Fornecedor**
...
4. **Histórico Unificado**: Vendas e compras no mesmo lugar
...
3. **Importação**: Importe listas de produtos e preços
4. **Atualização**: Mantenha códigos sempre atualizados

### 📈 **Histórico de Compras**
Acompanhe o relacionamento comercial:

1. **Pedidos**: Todos os pedidos realizados
2. **Recebimentos**: Produtos recebidos
3. **Pagamentos**: Histórico financeiro
4. **Avaliações**: Performance do fornecedor

## 💡 Casos de Uso

### 🏪 **Caso 1: Fornecedor Principal**
**Situação**: Distribuidora que fornece 80% dos produtos

**Configuração**:
- **Categoria**: Principal
- **Condições**: Prazo de 30 dias
- **Códigos**: Mapeamento completo
- **Contatos**: Vendedor dedicado
...
**Situação**: Empresa de manutenção e limpeza

**Configuração**:
- **Categoria**: Serviços
- **Pagamento**: À vista após execução
- **Contatos**: Técnico responsável
- **Documentos**: Certificações anexadas
...
### 🌍 **Caso 3: Fornecedor Internacional**
**Situação**: Importação de produtos específicos

**Configuração**:
- **Endereço**: País de origem
- **Moeda**: Dólar ou Euro
- **Documentos**: Certificados de importação
- **Prazos**: Longos para importação
...
- **Tags**: Marque fornecedores especiais
...
- **Fornecedores por Categoria** - Agrupados por tipo
